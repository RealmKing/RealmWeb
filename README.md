# RealmWeb
系统后台预览地址: localhost:8080 用户名:`realm`  密码:`123456`<br/>
技术交流QQ群：`651823824`<br/>
#主要功能
...
#快速体验
* 将源码导入IDE 
* 将源码路径下的src/main/resources/sql 中的realm-pro.sql导入到数据库中(dsrm.sql为定时任务的几张jibenbiao realm-pro.sql已经包含)
